...
<acme:form>
		...
		<acme:input-select code="administrator.aircraft.list.label.aircraftStatus" path="aircraftStatus" choices="${statuses}"/>
		<acme:input-textbox code="administrator.aircraft.list.label.details" path="aircraftDetails"/>
		<jstl:choose>
