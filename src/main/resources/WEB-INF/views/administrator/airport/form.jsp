...
<acme:form readonly="${readonly}">
	...
	<acme:input-textbox placeholder="[A-Z]{3}" code="administrator.airport.form.label.iataCode" path="iataCode"/>
	<acme:input-select code="administrator.airport.form.label.operationalScope" path="operationalScope" choices="${types}"/>
