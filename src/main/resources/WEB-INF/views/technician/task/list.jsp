...
<jstl:if test="${showCreate && maintenanceRecordId != null}">
	...
	<acme:button code="technician.task.list.button.link" action="/technician/maintenance-task-relation/create?maintenanceRecordId=${maintenanceRecordId}"/>
	<acme:button code="technician.task.list.button.unlink" action="/technician/maintenance-task-relation/delete?maintenanceRecordId=${maintenanceRecordId}"/>
