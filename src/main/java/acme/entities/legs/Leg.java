...
@Table(indexes = {
	@Index(columnList = "flight_id, draftMode, scheduledDeparture, scheduledArrival"), @Index(columnList = "status, draftMode"), @Index(columnList = "departure_airport_id, arrival_airport_id")
})
