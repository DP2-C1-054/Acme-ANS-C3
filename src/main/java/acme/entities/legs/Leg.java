...
@ValidLeg
@Table(indexes = {
	@Index(columnList = "flight_id, draftMode, scheduledDeparture, scheduledArrival"), @Index(columnList = "status, draftMode"), @Index(columnList = "departureAirport_id, arrivalAirport_id")
})
